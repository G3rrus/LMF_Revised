...
//WAIT UNTIL 5 MINUTES PASSED
private _time2 = time + 300;
waitUntil {time > _time2};

//REMOVE ACTION
[player,1,["ACE_SelfActions","tpToGroup"]] call ace_interact_menu_fnc_removeActionFromObject;