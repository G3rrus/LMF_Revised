...
// PLAYER GEAR ////////////////////////////////////////////////////////////////////////////////////
waitUntil {!isNil "a2k_fnc_playerGear"};
[player] spawn a2k_fnc_playerGear;

// GROUP MARKERS //////////////////////////////////////////////////////////////////////////////////
waitUntil {!isNil "var_groupMarkers"};
if (var_groupMarkers) then {[] execVM "a2k\scripts\groupMarkers.sqf";};

// UNIT TRACKER ///////////////////////////////////////////////////////////////////////////////////
waitUntil {!isNil "var_unitTracker"};
if (var_unitTracker) then {[] execVM "a2k\scripts\fn_unitTracker.sqf";};
