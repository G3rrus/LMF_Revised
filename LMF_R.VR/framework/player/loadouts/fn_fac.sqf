...
for "_i" from 1 to 2 do {_unit addItem _Rifle_GL_Smoke_Grn;};
for "_i" from 1 to 4 do {_unit addItem _Rifle_GL_Smoke_Red;};
for "_i" from 1 to 2 do {_unit addItem _Rifle_GL_Flare;};
